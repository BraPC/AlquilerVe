...
<div class="text-center py-6 px-4 container mx-auto text-gray-500 text-sm mt-12">
    <div class="md:flex justify-between items-center">
      <div class="mb-4 md:mb-0">Universidad Jose Antonio Paez <span class="text-red-500">♥</span> by <a class="hover:underline text-gray-600" href="https://twitter.com">BP & SL</a>. Licensed en proceso...</div>
